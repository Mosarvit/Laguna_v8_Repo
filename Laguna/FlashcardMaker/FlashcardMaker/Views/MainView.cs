...
namespace FlashcardMaker
{
    public partial class MainView : Form, ISessionView
    {
        ...
        private void btnAddCharactersToDatabase_Click(object sender, EventArgs e)
        {
            ...
            dataIOController.AddExcelDataToDatabase<ChineseCharacter>(Properties.Settings.Default.chineseCharactersXLS);
        }
        ...
        private void btnAddWordsToDatabase_Click(object sender, EventArgs e)
        {
            ...
            dataIOController.AddExcelDataToDatabase<ChineseWord>(Properties.Settings.Default.chineseWordsXLS);
        }
        ...
        private void btnImportWordsAndCharacters_Click_1(object sender, EventArgs e)
        {
            dataIOController.ImportWordsAndCharacters();
        }

        private void btnExportWordsAndCharacters_Click(object sender, EventArgs e)
        {
            dataIOController.ExportWordsAndCharacters();
        }
    }
}
